  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-50 flex justify-center h-20 font-aeonik">
      <div className="w-full max-w-screen-md px-5 border-t-2 border-borderMain bg-[#131313] flex items-center justify-between">
        <Link href="/" className={`relative flex flex-col items-center justify-center gap-2 px-5 border-none focus:outline-none group`}>
        ...
        <Link href="/friends" className={`relative flex flex-col items-center justify-center gap-2 px-5 border-none focus:outline-none group`}>
          <div className={`${isActive('/friends') ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'} bg-[#FFFFFF] blur-md w-4 h-4 transition-opacity duration-200`}></div>
          <svg
            width="23"
            height="18"
            viewBox="0 0 23 18"
            className={`${isActive('/friends') ? 'fill-[#FFFFFF] stroke-[#FFFFFF]' : 'fill-transparent group-hover:fill-[#FFFFFF] group-hover:stroke-[#FFFFFF] stroke-[#93969D]'} transition-colors duration-200 absolute left-1/2 -translate-x-1/2 top-2 -translate-y-1/2`}
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
          ...
          <span className={`${isActive('/friends') ? 'text-[#FFFFFF]' : 'text-[#93969D] group-hover:text-[#FFFFFF]'} text-xs transition-colors duration-200`}>
            Friends
          </span>
          <div className={`${isActive('/friends') ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'} absolute -bottom-3 translate-y-full left-0 w-full h-2 bg-[#FFFFFF] blur-lg`}></div>
        </Link>
        <Link href="/tasks" className={`relative flex flex-col items-center justify-center gap-2 px-5 border-none focus:outline-none group`}>
          <div className={`${isActive('/tasks') ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'} bg-[#FFFFFF] blur-md w-4 h-4 transition-opacity duration-200`}></div>
          <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
            className={`${isActive('/tasks') ? 'fill-[#FFFFFF] stroke-[#FFFFFF]' : 'fill-transparent group-hover:fill-[#FFFFFF] group-hover:stroke-[#FFFFFF] stroke-[#93969D]'} transition-colors duration-200 absolute left-1/2 -translate-x-1/2 top-2 -translate-y-1/2`}
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <span className={`${isActive('/tasks') ? 'text-[#FFFFFF]' : 'text-[#93969D] group-hover:text-[#FFFFFF]'} text-xs transition-colors duration-200 text-nowrap`}>
            Tasks & Earn
          </span>
          <div className={`${isActive('/tasks') ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'} absolute -bottom-3 translate-y-full left-0 w-full h-2 bg-[#FFFFFF] blur-lg`}></div>
        </Link>
      </div>
    </footer>
  )
